...
##图片灰化、高斯过滤以及canny
image = cv2.imread("pic/04.png")
# = cv2.resize(image, (720, 540), interpolation=cv2.INTER_CUBIC)
...
cv2.imwrite("result/lane_4_result.jpg", lane_image)
cv2.imwrite("result/lane_4_gray.jpg", gray_image)
cv2.imwrite("result/lane_4_edge.jpg", edge_image)
cv2.imwrite("result/lane_4_roi.jpg", roi_image)
cv2.imwrite("result/lane_4_line.jpg", line_image)
cv2.waitKey()
